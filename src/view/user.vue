        ...
        <div class="user-datum">
          ...
          <div class="user-datum-block">
            <transition
              ...
              @after-appear="afterEnter"
            >
            <div class="user-datum-value" v-text="userInfo.follower" :style="{color:$store.state.system.colorValue}"></div>
            </transition>
          ...
          <div class="user-datum-block">
            <transition
              ...
              @after-appear="afterEnter"
            >
            <div class="user-datum-value" v-text="userInfo.activity"  :style="{color:$store.state.system.colorValue}"></div>
            </transition>
      ...
      <div class="list-row">
        <div class="user-card">
          <div class="user-card-header">
            <span class="user-card-name" :style="{color:$store.state.system.colorValue}">Black Stone </span><span class="subLabel" :style="{color:$store.state.system.colorLabel}">Rapper</span>
          </div>
